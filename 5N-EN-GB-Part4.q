...
LOAD DATA LOCAL INPATH '/media/hive/Data/5N-EN-GB-Part4/' OVERWRITE INTO TABLE raw_ngrams;
...
INSERT OVERWRITE LOCAL DIRECTORY '/media/hive/Data/GB-Output4' SELECT * FROM sequence_ngrams;
