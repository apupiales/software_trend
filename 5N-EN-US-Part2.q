...
LOAD DATA LOCAL INPATH '/media/hive/Data/5N-EN-US-Part2/' OVERWRITE INTO TABLE raw_ngrams;
...
INSERT OVERWRITE LOCAL DIRECTORY '/media/hive/Data/US-Output2' SELECT * FROM sequence_ngrams;
