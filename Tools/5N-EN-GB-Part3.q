...
LOAD DATA LOCAL INPATH '/media/hive/Data/5N-EN-GB-Part3/' OVERWRITE INTO TABLE raw_ngrams;
...
INSERT OVERWRITE LOCAL DIRECTORY '/media/hive/Data/GB-Output3' SELECT * FROM sequence_ngrams;
