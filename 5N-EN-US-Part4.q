...
LOAD DATA LOCAL INPATH '/media/hive/Data/5N-EN-US-Part4/' OVERWRITE INTO TABLE raw_ngrams;
...
INSERT OVERWRITE LOCAL DIRECTORY '/media/hive/Data/US-Output4' SELECT * FROM sequence_ngrams;
